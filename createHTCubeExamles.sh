...
do
    ...
    do
        project_file=Ra_795_${solver}_${pc}_rtol_1e-10_atol_1e-10_tend_${tend}.prj
        cp templates/${model_revision}.prj ${project_dir}/${project_file}
        sed --in-place "s/LINEARSOLVER/${solver}/" ${project_dir}/Ra_795_${solver}_${pc}_rtol_1e-10_atol_1e-10_tend_${tend}.prj
        sed --in-place "s/PC/${pc}/" ${project_dir}/Ra_795_${solver}_${pc}_rtol_1e-10_atol_1e-10_tend_${tend}.prj
