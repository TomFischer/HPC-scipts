...
do
    ...
    do
        ...
        do
            ...
            cp templates/FaultedCube_HT_${branch_name}_scaling_experiment_50_ts.prj ${project_dir}/${project_file}
            ...
            cp templates/juwels_ht_script ${project_dir}/${submit_script}
